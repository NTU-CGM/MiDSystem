...
*/
$("input[name='taxo_setting']").change(function(){
    if($("#taxo_default").is(':checked')){
        $("table[name='taxo_table']").hide();
    }
    if($("#taxo_custom").is(':checked')){
        $("table[name='taxo_table']").show();
    }
});
$("input[name='pred_setting']").change(function(){
    if($("#pred_default").is(':checked')){
        $("table[name='pred_table']").hide();
    }
    if($("#pred_custom").is(':checked')){
        $("table[name='pred_table']").show();
    }
    
});
$("input[name='function_setting']").change(function(){
    if($("#function_default").is(':checked')){
        $("table[name='function_table']").hide();
    }
    if($("#function_custom").is(':checked')){
        $("table[name='function_table']").show();
    }
    
});
$("input[name='non_annotate_setting']").change(function(){
    if($("#non_annotate_default").is(':checked')){
        $("table[name='non_annotate_table']").hide();
    }
    if($("#non_annotate_custom").is(':checked')){
        $("table[name='non_annotate_table']").show();
    }
